...
export default function App() {
  ...
  return (
    <div className="bg-brand-sand min-h-screen text-brand-blue-900 selection:bg-brand-blue-100 selection:text-brand-blue-900 transition-colors duration-300">
      ...
      {/* ──────────────────────────────────────────────────────── */}
      {/* SECTION 4: RECIPE PLANNER (CÔNG THỨC CHẾ BIẾN THƯỢNG HẠNG) */}
      {/* ──────────────────────────────────────────────────────── */}
      <RecipesSection onAddToCart={handleAddToCart} />


      {/* ──────────────────────────────────────────────────────── */}
      {/* SECTION NEWS: MEDIA PRESS COVERAGE (TIN TỨC TRUYỀN THÔNG) */}
      {/* ──────────────────────────────────────────────────────── */}
      <section id="news" className="py-20 bg-white border-b border-brand-blue-100/50 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="news-header" className="text-center max-w-2xl mx-auto mb-10 space-y-3">
            <span className="text-[#0070f3] text-xs uppercase tracking-widest font-extrabold font-display block">
              BÁO CHÍ & TRUYỀN THÔNG
            </span>
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-brand-blue-900 tracking-tight">
              TIN TỨC NỔI BẬT VỀ GNOD FOOD
            </h2>
            <p className="text-slate-500 text-sm leading-relaxed">
              Các đầu báo uy tín Việt Nam như VnExpress, CafeBiz, Kenh14 và Zing News phản ánh góc nhìn tích cực về trào lưu ẩm thực vị biển tiện lợi từ Gnod Food.
            </p>
            <div className="w-12 h-1 bg-[#0070f3] mx-auto rounded-full" />
          </div>
          <NewsSection />
